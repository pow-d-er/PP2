#ifndef stos_long_long_int_h
#define stos_long_long_int_h
#include <stdio.h>
#include <stdlib.h>
#include <stdbool.h>

typedef struct stack_long_long_int_t stack_long_long_int_t;

struct stack_long_long_int_t{
int size;
int howMuch;
long long int value;
stack_long_long_int_t* prevStack;
};
